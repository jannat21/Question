(function ()
{
    ...
    function questionFactory($http) {
        ...
        qf.changeQuestionStatus = function (question, newStatus) {
            var datas = {questionID: question.questionID, newStatus: newStatus};
            return $http({url: siteUrl + '/Question/changeQuestionStatus', method: 'POST', data: datas});
        };
