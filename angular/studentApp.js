...
//        };
    ...
    function config($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
                .state("studentHome", {url: "/", templateUrl: siteUrl + "/views/loadView/studentHomeView/student",controller: "studentHomeCtrl as shc"})
                ...
                .state("examination", {url: "/examination", templateUrl: siteUrl + "/views/loadView/studentExaminationView/examination", controller: "studentExaminationCtrl as sec"})
                .state("examinationList", {url: "/examinationList", templateUrl: siteUrl + "/views/loadView/studentExaminationListView/examination", controller: "studentExaminationListCtrl as selc"})
