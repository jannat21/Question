...
(function () {
    "use strict";
    var app = angular.module("courseQuestion", ['ui.router', 'serviceModule','ngAnimate','oi.select','webcam']);
    app.config(config);
    app.run(Run);
    ...
    function config($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
                ...
                .state("examinationList", {url: "/examinationList", templateUrl: siteUrl + "/views/loadView/examinationListView/examination",controller:"examinationListCtrl as elc"})
                .state("checkExamination", {url: "/checkExamination/:md5ID", templateUrl: siteUrl + "/views/loadView/checkExaminationView/examination",controller:"checkExaminationCtrl as cec"})
                .state("school", {url: "/school", templateUrl: siteUrl + "/views/loadView/schoolView/school",controller:"schoolCtrl as sc"})
